...
|--------------------------------------------------------------------|--------------|--------------------|-------------------------|
| ![Chrome](https://sig.edgeno.de/assets/browser-icons/chrome.png)   | 55%          | 48 - 56            | Implemented             |
| ![Firefox](https://sig.edgeno.de/assets/browser-icons/firefox.png) | 11%          | Not supported      | Ready to be implemented |
| ![Edge](https://sig.edgeno.de/assets/browser-icons/edge.png)       | 5%           | Not supported      | No webrtc support       |
| ![Safari](https://sig.edgeno.de/assets/browser-icons/safari.png)   | 4%           | Not supported      | No webrtc support       |
